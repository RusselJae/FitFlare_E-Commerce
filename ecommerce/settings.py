...
SECRET_KEY = 'django-insecure-n78z8#)l#2aw%wn&^)8-@y4xudqw2^atki#rai@=do37s31xuv'
...
INSTALLED_APPS = [
    ...
    'clothingstore',  # Your app name here
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'clothingstore.context_processors.global_categories',  # Custom context processor
            ],
        },
    },
]
